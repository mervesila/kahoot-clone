...
namespace TKI.Persistence.Migrations
{
    ...
    [Migration("20260819134749_AddExamAttemptStudentFields")]
    partial class AddExamAttemptStudentFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ExamAnswer", b =>
                {
                    ...
                    b.HasIndex("ExamAttemptId", "QuestionIndex")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.GameSessionQuestion", b =>
                {
                    ...
                    b.HasIndex("GameSessionId", "OrderNo")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.UserQuizResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
